...
public class ToDoModel {
    ...
    public Set<ToDoModel> getToDo() throws SQLException {
        try {
            ConnectionDataBase connectionDb = new ConnectionDataBase();
            Connection connection = connectionDb.getConexao();
            ...
            while (result.next()) {
                ...
                Integer idAluno = result.getString("idaluno");
                toDo.setIdStudent(idAluno);
                String idEntrega = result.getString("identrega");
                toDo.setIdIssue(idEntrega);
                toDoList.add(toDo);
            }
            return toDoList;
